 ...
 *
 */
@XStreamAlias("corporataccount")
public class CorporatAccountInfo implements Serializable{
	private static final long serialVersionUID = 1L;
	@XStreamAlias("corporateaccountid")
	...
	@XStreamAlias("openaccountdate")
	private java.util.Date openAccountDate;
	@XStreamAlias("openaccountdescription")
