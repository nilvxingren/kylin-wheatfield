...
public interface OrderService {
	 ...
	 * @return
	 */
	List<TransOrderInfoNew> getTransOrdersNew(String userId,String orderNo,String merchantCode, String startTime,String endTime,String funcCode,String status);
}
