...
public class TransOrderInfoDaoTest extends AbstractJUnit4SpringContextTests {
   ...
   @Test
    public void selectSummaryInfoTest() {
        Map<String,String> summaryMap = new HashMap<String,String>();
        summaryMap.put("accountDate", "2016-05-04");
//        summaryMap.put("funcCode", TransCodeConst.CHARGE+","+TransCodeConst.FUNCTION_CHARGE);
        summaryMap.put("funcCode", TransCodeConst.PAYMENT_PA40142);
        List<Map<String, Object>> l = transOrderInfoDao.selectSummaryInfo(summaryMap);
        logger.info(l+"");
    }
