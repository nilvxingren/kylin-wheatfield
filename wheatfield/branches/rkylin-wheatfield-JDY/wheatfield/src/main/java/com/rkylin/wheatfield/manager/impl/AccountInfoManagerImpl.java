...
public class AccountInfoManagerImpl implements AccountInfoManager {
	...
	@Override
	public void deleteAccountInfoById(Integer accountId) {
		accountInfoDao.deleteByPrimaryKey(accountId);
	}
...
//	@Override
//    public List<AccountInfo> selectAccInfo(AccountInfoQuery query) {
...
//            query.setPageNum(0);
//        }	    
//        return accountInfoDao.selectAccInfo(query);
//    }
}
