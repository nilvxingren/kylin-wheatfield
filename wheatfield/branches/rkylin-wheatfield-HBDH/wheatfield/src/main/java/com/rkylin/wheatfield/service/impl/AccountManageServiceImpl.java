...
//				}
	...
	*/
    ...
    private CommonResponse toPengYuanVerify(AccountInfo accountInfo,String instCode){
        ...
        logger.info("多渠道返回码=="+personBankCheckRespDto.getReturnCode()+", 信息="+personBankCheckRespDto.getReturnMsg());
        CommonResponse res = new CommonResponse();
        res.setCode(CodeEnum.FAILURE.getCode());
        logger.info("去鹏元校验personBankCheckRespDto.getChannelCode()="+personBankCheckRespDto.getChannelCode());
