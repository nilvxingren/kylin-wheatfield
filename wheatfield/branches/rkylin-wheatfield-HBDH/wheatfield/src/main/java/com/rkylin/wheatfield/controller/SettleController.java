...
//	@RequestMapping("/test")
//	public void test(String orderNo,HttpServletResponse response){
//		
//		OrderDetail orderDetail = new OrderDetail();
//		orderDetail.setOrderNo(orderNo);
//		orderDetail.setRootInstCd("M000001");
//		orderDetail.setStatusId(15);
//		generationPaymentService.refund99(orderDetail);	
//		
//	}
	
	
//	@RequestMapping("/test")
//	public void test(String orderNo,String date,HttpServletResponse response){
//		if ("1".equals(orderNo)) {
//			GenerationPaymentQuery query = new GenerationPaymentQuery();
//			query.setRemark("50_ORDER_FN_COLL");
//			List<GenerationPayment>  list3 = generationPaymentManager.queryList(query);
//			OrderDetails orderDetails = new OrderDetails();
//			List list = new ArrayList();
//			for(GenerationPayment gen3:list3){
//				OrderDetail orderDetail = new OrderDetail();
//				orderDetail.setOrderNo(gen3.getOrderNo());
//				orderDetail.setStatusId(15);
//				orderDetail.setRootInstCd(gen3.getRootInstCd());
//				list.add(orderDetail);
//			}
//			orderDetails.setOrderDetails(list);
//			generationPaymentService.refund99(orderDetails);
//		}else{
//			GenerationPaymentQuery query = new GenerationPaymentQuery();
//			query.setRemark("51_ORDER_FN_COLL");
//			List<GenerationPayment>  list3 = generationPaymentManager.queryList(query);
//			OrderDetails orderDetails = new OrderDetails();
//			List list = new ArrayList();
//			for(GenerationPayment gen3:list3){
