...
public class TransDaysSummaryDaoImpl extends BaseDao implements TransDaysSummaryDao {
	...
	@Override
	public void insertBatch(List<TransDaysSummary> list) {
		super.getSqlSession().insert("TransDaysSummaryMapper.insertBatch", list);
	}

    @Override
    public List<TransDaysSummary> selectByPrimaryKeys(List<String> list) {
        return super.getSqlSession().selectList("TransDaysSummaryMapper.selectByPrimaryKeys", list);
    }
