...
import com.rkylin.wheatfield.bean.FinCompanyQuery;
...
//           user.setOperType("insert");
    ...
    public void getFinAccountBalanceTest(){
       ...
       @Test
       public void getFinCompanyInfoTest(){
           com.rkylin.wheatfield.bean.FinCompanyQuery query = new FinCompanyQuery();
           query.setRootInstCd("M000003");//
           query.setBuslince("145311120972616289961");
           query.setFinAccountId("TCA20160118180000051");
           query.setDataSize(7);
           query.setOrganCertificate("4535345");
           query.setCorporateIdentity("232424");
           CommonResponse res = accountInfoDubboService.getFinCompanyInfo(query);
           System.out.println(res);
           
       }   
       
       @Test
       public void getFinPersonInfoTest(){
           FinPersonQuery query = new FinPersonQuery();
           query.setRootInstCd("M000003");//
           query.setDataSize(7);//
           query.setFinAccountId("TCA20150814105900511");
           query.setCertificateNumber("232321198808221292");
           query.setPersonChnName("哦也");
           query.setPersonEngName("Achi000");
           CommonResponse res = accountInfoDubboService.getFinPersonInfo(query);
           System.out.println(res);
