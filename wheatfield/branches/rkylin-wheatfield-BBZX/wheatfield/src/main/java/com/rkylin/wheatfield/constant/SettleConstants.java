...
//	public static final String FILE_UP_PATH = "c:\\test\\upload\\";
	 ...
	 * 代收付表SEND_TYPE:已发送
	 */	
	public static final int GEN_SEND_TYPE_SENT = 2;
	/**
	 * 代收付表SEND_TYPE:发送临时状态
	 */	
	public static final int GEN_SEND_TYPE_TEM = 3;
	/**
	 * 代收付表SEND_TYPE:发送失败
	 */	
	public static final int GEN_SEND_TYPE_FAILURE = 4;
}
