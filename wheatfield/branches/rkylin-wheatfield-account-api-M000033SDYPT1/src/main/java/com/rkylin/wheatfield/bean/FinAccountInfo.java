...
public class FinAccountInfo  implements Serializable{
    ...
    private Long balanceUseble;
    
    public Long getBalanceUseble() {
        return balanceUseble;
    }
    public void setBalanceUseble(Long balanceUseble) {
        this.balanceUseble = balanceUseble;
    }
