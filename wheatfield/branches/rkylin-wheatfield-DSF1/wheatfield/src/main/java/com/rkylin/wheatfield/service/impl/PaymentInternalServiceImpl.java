...
public class PaymentInternalServiceImpl implements PaymentInternalService,PaymentInternalOutService,IAPIService {
	...
	//@Autowired
	//TransSettlementService transSettlementService;
	...
	public Long getInternalBalance(String userId,String rootInstCd,String productId,String referUserId) {
		...
		if(null!=balance){
			if(Constants.FN_PRODUCT.equals(productId)){//提现余额
				amount=balance.getBalanceSettle();
			}else if(Constants.USER_SUB_ACCOUNT.equals(productId)){//信用余额
				amount=balance.getBalanceCredit();
			}
		}else {
	...
	@Override
	public WipeAccountResponse wipeAccountPlat(String arg0, String arg1, String arg2) {
		// TODO Auto-generated method stub
		return null;
	}
}
