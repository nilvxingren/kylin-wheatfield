...
public class PaymentAccountServieImpl implements PaymentAccountService,IAPIService,PaymentAccountServiceApi {
	...
	public ErrorResponse withhold(TransOrderInfo transOrderInfo,String productId) {
		...
		synchronized (lock) {
			...
			//user.constId=transOrderInfo.getMerchantCode();
			//user.productId=productId;
			if(transOrderInfo.getMerchantCode().equals(Constants.KZ_ID)||transOrderInfo.getMerchantCode().equals(Constants.FN_ID)||productId.equals(Constants.HT_CHANGDIFANG_ACCOUNT) || transOrderInfo.getMerchantCode().equals(Constants.JRD_ID) || transOrderInfo.getMerchantCode().equals(Constants.MZ_ID) || transOrderInfo.getMerchantCode().equals(Constants.SQSM_ID)||transOrderInfo.getMerchantCode().equals(Constants.ZK_ID)){
				user.constId=transOrderInfo.getMerchantCode();
				user.productId=productId;
			}else{
				user.constId=Constants.HT_ID;
...
//					flag=false;
	...
	@Override
	public BalanceResponse getUserBalance(User arg0, String arg1, String arg2) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public ReversalResponse reversalPlat(String arg0, String arg1, String arg2, String arg3, String arg4) {
		// TODO Auto-generated method stub
		return null;
	}
}
