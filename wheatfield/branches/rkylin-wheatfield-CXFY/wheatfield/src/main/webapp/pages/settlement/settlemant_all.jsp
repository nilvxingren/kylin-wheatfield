...
function submit_k(obj){
	if (obj == 1) {
		document.getElementById("flg_OK").value = "faqi1fen";
	} else if (obj == 2) {
		document.getElementById("flg_OK").value = "duru1fen";
	}
...
<body>
	<form name="queryFrm" id="queryFrm" action="settementall" target="_self"
		method="post">
					...
					<tr>
						...
						<td>
							<table border="0" width="100%" class="boder ticky-wrap">
								<tr>
									<td width="5%" nowrap align="right">全机构发起1分钱鉴证代付交易:</td>
									<td width="24%"><input type="button" id="onecent"
										name="onecent" value="开始"
										style="width:80%" onclick="submit_k(1);"/></td>
									<td nowrap align="right" width="5%">全机构读取1分钱代付结果修改卡状态：</td>
									<td width="24%"><input type="button" id="updateAccountoneCent"
										name="updateAccountoneCent" value="开始"
										style="width:80%" onclick="submit_k(2);"/>
									</td>
								</tr>
							</table>
						</td>
