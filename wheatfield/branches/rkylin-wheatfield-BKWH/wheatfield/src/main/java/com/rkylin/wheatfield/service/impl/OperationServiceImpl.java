		...
		if(flag){
			if(transOrderInfo.getErrorCode()!=null){
				...
				if(transOrderInfo.getMerchantCode().equals(Constants.JRD_ID)|| transOrderInfo.getMerchantCode().equals(Constants.TXYW_ID)
				        || transOrderInfo.getMerchantCode().equals(Constants.ZJDY_ID)
				        ||Constants.FC_ID.equals(transOrderInfo.getMerchantCode())
				        ||Constants.LINGKE_ID.equals(transOrderInfo.getMerchantCode())){
