...
import com.rkylin.wheatfield.task.AccountTask;
...
public class SettleController extends BaseDao {
	 ...
	 */
       ...
       * @since 2016年7月27日
       */
        @RequestMapping("/sendToGateRouter")
        public void sendToGateRouter(HttpServletResponse response){
            response.setCharacterEncoding("UTF-8");  
            ...
            CommonResponse res =generationPayDubboService.submitToGateRouterTransferBatch(request.getParameter("accountDate"),send,
