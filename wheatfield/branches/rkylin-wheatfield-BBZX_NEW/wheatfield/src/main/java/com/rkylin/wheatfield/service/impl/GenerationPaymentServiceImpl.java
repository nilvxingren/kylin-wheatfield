...
//		List<TransOrderInfo>
	...
	public  CommonResponse submitToGateRouter40143(String accountDate,Integer sendType){
        GenerationPaymentQuery query=new GenerationPaymentQuery();
        query.setStatusId(Integer.parseInt(BaseConstants.ACCOUNT_STATUS_OK));
        query.setRootInstCd(Constants.YQMS_KZ_ID);
	    ...
	    dto.setSysNo("zhxt003");
	    dto.setTransCode("16012");
	    dto.setOrgNo(Constants.YQMS_KZ_ID);
        ...
        String batchNo = "U"+CommUtil.getGenerateNum(2)+"_40143";
	    dto.setBatchNo(batchNo);
	    dto.setTotalAcount(generationPaymentList.size());
	    dto.setCurrency("CNY");
//	    dto.setAccountNo("");
	    dto.setAccountType(20);
//	    dto.setAccountName("");
	    ...
	    for (GenerationPayment generationPayment : generationPaymentList) {
	        ...
	        paymentDto.setSysNo("zhxt003");
	        paymentDto.setTransCode("16012");
	        paymentDto.setOrgNo(Constants.YQMS_KZ_ID);
...
//	        paymentDto.setPayerAccountName(payerAccountName);
	    ...
	    queryDto.setSysNo("zhxt001");
	    queryDto.setTransCode("16001");
	    queryDto.setOrgNo(Constants.YQMS_KZ_ID);
