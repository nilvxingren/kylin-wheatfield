...
/**
 * FinanaceCompanyQuery
 * @author code-generator
 *
 */
public class FinanaceCompanyQuery implements Serializable{
	...
	private String accountRelateId;
    ...
    public String getAccountRelateId() {
		return accountRelateId;
	}

	public void setAccountRelateId(String accountRelateId) {
