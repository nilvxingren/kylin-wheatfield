...
%>
<!-- http://localhost:8080/wheatfield/pages/account/refundQjs.jsp -->
...
<script language="JavaScript" type="text/JavaScript">
	function submitRefund(){
		...
		if(!confirm("您确定退票吗?")){
		 ...
		 $.ajax({  
	         type: "POST",      
	         url: '<%=basePath%>'+'handleRefundQjs',  
	         dataType:'json',
	         data:"orderNo="+orderNo+"&insCode="+insCode+"&errorMsg="+errorMsg,
		...
		<table>
			<tr>
	          	<td>
	          		...
	          		错误信息：<input type="text" id='errorMsg' name="errorMsg">
	          		<input type="button" value="确定" onclick="submitRefund()" />
	          	</td>
			</tr>
		</table>
	</form>
