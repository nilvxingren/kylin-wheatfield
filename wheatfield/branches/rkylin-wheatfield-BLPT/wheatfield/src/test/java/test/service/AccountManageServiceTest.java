...
public class AccountManageServiceTest extends BaseJUnit4Test{
    ...
    public void selectAccountListForJspTest(){
        ...
        query.setAccountName("18701514648");
        query.setAccountPurpose("8");
        List<AccountInfo>  res = accountManagementService.selectAccountListForJsp(query);
...
//      }
	...
	public void testBindingBankAccount(){
		...
		String result = accountManageService.bindingBankAccount(user, accountInfo,null);
