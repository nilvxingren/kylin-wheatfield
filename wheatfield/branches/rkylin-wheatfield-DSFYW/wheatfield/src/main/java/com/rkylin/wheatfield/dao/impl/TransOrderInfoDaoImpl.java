...
public class TransOrderInfoDaoImpl extends BaseDao implements TransOrderInfoDao {
    ...
    @Override
    public void batchUpdateByOrderNoAndMerCode(List<TransOrderInfo> list) {
        super.getSqlSession().update("TransOrderInfoMapper.batchUpdateByOrderNoAndMerCode", list);
    }
